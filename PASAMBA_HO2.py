...
tk.Label(window,text="Name:Ken Joshua Pasamba",font=("Calibri",20),bg="Brown").pack(anchor="w")
...
tk.Label(window,text="Birthday:May 8 2006",bg="Brown",font=("Calibri",20)).pack(anchor="w")
tk.Label(window,text="Motto:Work for a Cause, Not for Applause",bg="Brown",font=("Calibri",20)).pack(anchor="w")
